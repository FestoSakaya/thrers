...
if($_POST['doSaveBudget']=='Save and Next' and $id and $_POST['primary_sponsor'] and $id){
...
$sqlInvestigators="SELECT * FROM ".$prefix."research_project_expenditure where `rstug_user_id`='$sasrmApplctID' and rstug_rsch_project_id='$id' order by rstug_expenditure_id desc";
...
$r= $cmdwb->fetch_array();
if($totalStages and $_POST['pyrlocal1']>=1 and $_POST['mtrlocal1']>=1 and $_POST['tradmlocal1']>=1 and $_POST['travellocal']>=1){
$sqlASubmissionStages="update ".$prefix."submission_stages  set `budget`='1' where `owner_id`='$sasrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages);
}
if($totalStages and $_POST['pyrlocal1']==0 || $_POST['mtrlocal1']==0 || $_POST['tradmlocal1']==0 || $_POST['travellocal']==0){
$sqlASubmissionStages="update ".$prefix."submission_stages  set `budget`='0' where `owner_id`='$sasrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages);
}
...
if($totalStages and $_POST['personellocal']>=1 and $_POST['travellocal']>=1 and $_POST['materialslocal']>=1){
$sqlASubmissionStages="update ".$prefix."submission_stages  set `budget`='1' where `owner_id`='$sasrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages);
}
if($totalStages and $_POST['personellocal']==0 || $_POST['travellocal']==0 || $_POST['materialslocal']==0){
$sqlASubmissionStages="update ".$prefix."submission_stages  set `budget`='0' where `owner_id`='$sasrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages);
}
...
$sqlA2Protocol="update ".$prefix."submission  set `funding_source`='$funding_source',`primary_sponsor`='$primary_sponsor',`secondary_sponsor`='$secondary_sponsor',`PrimarySponsorCountry`='$PrimarySponsorCountry',`PrimarySponsorInstitution`='$PrimarySponsorInstitution',`SecondarySponsorCountry`='$SecondarySponsorCountry',`SecondarySponsorInstitution`='$SecondarySponsorInstitution' where id='$id' and owner_id='$sasrmApplctID'";
...
echo '<meta http-equiv="REFRESH" content="0;url='.$base_url.'/main.php?option=submissionSchedule&id='.$id.'">';
}
}
...
<table border="1" cellspacing="0" cellpadding="0" align="left" width="100%" id="vouchers" class="table success">
  ...
  <tr>
    <td width="184" align="left" valign="bottom" class="defmf"><strong>Travel <font color="#CC0000">*</font></strong></td>
...
?>
<option value="<?php echo $rCountrycv['id'];?>" <?php if($rCountrycv['id']==$rstudy['PrimarySponsorCountry']){?>selected="selected"<?php }?>><?php echo $rCountrycv['name'];?></option>
<?php }?>
</select>
