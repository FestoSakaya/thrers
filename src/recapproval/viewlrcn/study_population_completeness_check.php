...
$sqlASubmissionStages="update ".$prefix."submission_stages  set `study_population`='1' where `owner_id`='$sasrmApplctID' and `protocol_id`='$submission_id'";
...
echo '<meta http-equiv="REFRESH" content="0;url='.$base_url.'/main.php?option=submissionFourUp&id='.$id.'">';
}
...
$sqlAREvisedSections_update="update ".$prefix."updated_sections  set `study_population`='1' where owner_id='$sasrmApplctID' and protocol_id='$submission_id' and status='pending'";
