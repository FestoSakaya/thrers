...
<li><a href="#" rel="#default" class="selected">Confirm Payment</a></li>
...
$update="update ".$prefix."submission set paymentStatus='$paymentStatus', payments_comment='$payments_comment' where id='$id' and protocol_id='$protocol_idmm' and owner_id='$asrmApplctID_user'";
$mysqli->query($update);
$message='<p class="success">Thank you, protocol payment has been updated.</p>';
...
?>
 ...
 <?php
$Q_RR="select * from ".$prefix."research_project_expenditure where rstug_user_id='$owner_id' and rstug_rsch_project_id='$protocol_idwe' order by rstug_expenditure_id desc";
$QCMDRR=$mysqli->query($Q_RR);
$rSMM=$QCMDRR->fetch_array();
...
<table border="1" cellspacing="0" cellpadding="0" align="left" width="100%" id="vouchers" class="table">
  ...
  <tr>
    ...
    <td width="187" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_year1']){echo $rSMM['rstug_personnel_year1'];}else{ echo "0";}?></td>
    <td width="152" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_year2']){echo $rSMM['rstug_personnel_year2'];}else{ echo "0";}?></td>
    <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_year3']){echo $rSMM['rstug_personnel_year3'];}else{ echo "0";}?></td>
    <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_year4']){echo $rSMM['rstug_personnel_year4'];}else{ echo "0";}?></td>
     <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_year5']){echo $rSMM['rstug_personnel_year5'];}else{ echo "0";}?></td>
    <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_personnel_total']){echo $rSMM['rstug_personnel_total'];}else{ echo "0";}?></td>
  </tr>
  <tr>
    <td width="184" align="left" valign="bottom"><strong>Travel <font color="#CC0000">*</font></strong></td>
    <td width="187" align="center" valign="bottom"><?php if($rSMM['rstug_travel_year1']){echo $rSMM['rstug_travel_year1'];}else{ echo "0";}?></td>
    <td width="152" align="center" valign="bottom"><?php if($rSMM['rstug_travel_year2']){echo $rSMM['rstug_travel_year2'];}else{ echo "0";}?></td>
    <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_travel_year3']){echo $rSMM['rstug_travel_year3'];}else{ echo "0";}?></td>
   
   
   <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_travel_year4']){echo $rSMM['rstug_travel_year4'];}else{ echo "0";}?></td>
   
   <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_travel_year5']){echo $rSMM['rstug_travel_year5'];}else{ echo "0";}?></td>
   
    <td width="154" align="center" valign="bottom"><?php if($rSMM['rstug_travel_total']){echo $rSMM['rstug_travel_total'];}else{ echo "0";}?></td>
  </tr>
  <tr>
    <td width="184" align="left" valign="bottom"><strong>Materials and Supplies</strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_year2'];?></td>
    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_year3'];?></td>
    
    
<td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_year4'];?></td>
<td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_year5'];?></td>

    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_materials_total'];?></td>
  </tr>
  <tr>
    <td width="184" align="left" valign="bottom"><strong>Administration</strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_year2'];?></td>
    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_year3'];?></td>
    
    
 <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_year4'];?></td>
  <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_year5'];?></td>
  
    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_adminstration_total'];?></td>
  </tr>
  <tr>
    <td width="184" align="left" valign="bottom"><strong>Results dissemination</strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_results_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_results_year2'];?></td>
    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_results_year3'];?></td>
    
     <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_results_year4'];?></td>
      <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_results_year5'];?></td>

    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_results_total'];?></td>
  </tr>
 
  <tr>
    <td width="184" align="left" valign="bottom"><strong>Contingency</strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_contigency_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_contigency_year2'];?></td>
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_contigency_year3'];?></td>
    
    
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_contigency_year4'];?></td>
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_contigency_year5'];?></td>
    
    
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_contigency_total'];?></td>
  </tr>
  
  
   <tr>
    <td width="184" align="left" valign="bottom"><strong>Reimbursement and Time Compensations </strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_reimbursement_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_reimbursement_year2'];?></td>
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_reimbursement_year3'];?></td>
    
    
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_reimbursement_year4'];?></td>
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_reimbursement_year5'];?></td>
    
    
    <td width="154" align="center" valign="bottom" ><?php echo $rSMM['rstug_reimbursement_total'];?></td>
  </tr>
   <tr>
    <td width="184" align="left" valign="bottom"><strong>Other</strong></td>
    <td width="187" align="center" valign="bottom"><?php echo $rSMM['rstug_other_year1'];?></td>
    <td width="152" align="center" valign="bottom"><?php echo $rSMM['rstug_other_year2'];?></td>
    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_other_year3'];?></td>
    
<td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_other_year4'];?></td>
<td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_other_year5'];?></td>

    <td width="154" align="center" valign="bottom"><?php echo $rSMM['rstug_other_total'];?></td>
  </tr>
<?php
$year2=0;
$year1=($rSMM['rstug_personnel_year1']+$rSMM['rstug_travel_year1']+$rSMM['rstug_materials_year1']+$rSMM['rstug_adminstration_year1']+$rSMM['rstug_results_year1']+$rSMM['rstug_other_year1']+$rSMM['rstug_contigency_year1']+$rSMM['rstug_reimbursement_year1'])+0;

$year2=($rSMM['rstug_personnel_year2']+$rSMM['rstug_travel_year2']+$rSMM['rstug_materials_year2']+$rSMM['rstug_adminstration_year2']+$rSMM['rstug_results_year2']+$rSMM['rstug_other_year2']+$rSMM['rstug_contigency_year2']+$rSMM['rstug_reimbursement_year2'])+0;
//+$rSMM['rstug_other_year2']+$rSMM['rstug_contigency_year2']+$rSMM['rstug_reimbursement_year2']

$year3=($rSMM['rstug_personnel_year3']+$rSMM['rstug_travel_year3']+$rSMM['rstug_materials_year3']+$rSMM['rstug_adminstration_year3']+$rSMM['rstug_results_year3']+$rSMM['rstug_other_year3']+$rSMM['rstug_contigency_year3']+$rSMM['rstug_reimbursement_year3'])+0;

$year4=($rSMM['rstug_personnel_year4']+$rSMM['rstug_travel_year4']+$rSMM['rstug_materials_year4']+$rSMM['rstug_adminstration_year4']+$rSMM['rstug_results_year4']+$rSMM['rstug_other_year4']+$rSMM['rstug_contigency_year4']+$rSMM['rstug_reimbursement_year4'])+0;

$year5=($rSMM['rstug_personnel_year5']+$rSMM['rstug_travel_year5']+$rSMM['rstug_materials_year5']+$rSMM['rstug_adminstration_year5']+$rSMM['rstug_results_year5']+$rSMM['rstug_other_year5']+$rSMM['rstug_contigency_year5']+$rSMM['rstug_reimbursement_year5'])+0;
?>
 <tr>
	...
	$grandTotal=($rSMM['rstug_personnel_total']+$rSMM['rstug_travel_total']+$rSMM['rstug_materials_total']+$rSMM['rstug_adminstration_total']+$rSMM['rstug_results_total']+$rSMM['rstug_other_total']+$rSMM['rstug_contigency_total']+$rSMM['rstug_reimbursement_total']);
...
<?php
if($rowRows2['quantity']){$Qty=($rowRows2['quantity']+$Qty);}
}
...
<?php
$sqlgg = "select * FROM ".$prefix."submission where owner_id='$owner_id' and protocol_id='$protocol_idwe'";//and conceptm_status='new' 
