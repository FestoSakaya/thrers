...
if($_POST['doSaveThree']=='Save and Next' and $_POST['study_design'] and $_POST['gender_id'] and $_POST['asrmApplctID'] and $id){
	...
	$minimum_age_period=$mysqli->real_escape_string($_POST['maximum_age_period']);//$minimum_age_period=$mysqli->real_escape_string($_POST['minimum_age_period']);
	$maximum_age_period=$mysqli->real_escape_string($_POST['maximum_age_period']);
...
//!$totalStagesGend and !$maximum_age_periodm and !$maximum_agem and 
...
$sqlAREvisedSections_update="update ".$prefix."updated_sections  set `RecruitmentCountries`='1' where owner_id='$sasrmApplctID' and protocol_id='$submission_id' and status='pending'";
...
//Insert into Submission Stages
 $wm="select * from ".$prefix."submission_stages where  owner_id='$sasrmApplctID' and protocol_id='$submission_id' and status='new' order by id desc limit 0,1";
$cmdwb = $mysqli->query($wm);
$totalStages = $cmdwb->num_rows;
$r= $cmdwb->fetch_array();

$sqlstudyData="SELECT * FROM ".$prefix."submission where `owner_id`='$sasrmApplctID' and is_sent='0' and id='$submission_id' order by id desc limit 0,1";
$QuerystudyData = $mysqli->query($sqlstudyData);
$rstudyData = $QuerystudyData->fetch_array();

$sqlstudyData2="SELECT * FROM ".$prefix."clinical_study_methodology where `owner_id`='$sasrmApplctID' and is_sent='0' order by id desc limit 0,1";
...
$mysqli->query($sqlASubmissionStages);
}else{$sqlASubmissionStages="update ".$prefix."submission_stages  set `study_description`='0' where `owner_id`='$sasrmApplctID' and `protocol_id`='$submission_id'";
$mysqli->query($sqlASubmissionStages);}
...
$sqlAREvisedSections_update="update ".$prefix."updated_sections  set `study_description`='1' where owner_id='$sasrmApplctID' and protocol_id='$submission_id' and status='pending'";
$mysqli->query($sqlAREvisedSections_update);	
...
echo '<meta http-equiv="REFRESH" content="0;url='.$base_url.'/main.php?option=StudyPopulationUp&id='.$id.'">';
...
$rstudymethodology['interventions'];
//submission_stages
...
<?php if($totalstudy>=1){?><li><a href="./data/submissionCheck/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['protocol_information']==1 and $rsSubStages['protocol_team']==1){?> style="background:green; color:#FFF;" <?php }?>>Protocol Information</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./data/submissionSecondUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['protocol_details']==1){?> style="background:green; color:#FFF;" <?php }?>>Protocol Details</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./data/StudyPopulationUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['study_population']==1){?> style="background:green; color:#FFF;" <?php }?>>Study Population</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./data/submissionFourUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['registry']==1){?> style="background:green; color:#FFF;" <?php }?>>Registry</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['registry']==1){?> style="background:green; color:#FFF;" <?php }?>>Registry</li><?php }}?>

<?php if($totalstudy>=1){?><li><a href="./data/submissionBudgetUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['budget']==1){?> style="background:green; color:#FFF;" <?php }?>>Budget</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['budget']==1){?> style="background:green; color:#FFF;" <?php }?>>Budget</li><?php }?>

<?php if($totalstudy>=1){?><li><a href="./data/submissionScheduleUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['study_work_plan']==1){?> style="background:green; color:#FFF;" <?php }?>>Study Work Plan</a></li><?php }?>
...
<?php /*?><?php if($totalstudy>=1){?><li><a href="./data/submissionFive/<?php echo $rstudy['id'];?>/"<?php if($rsSubStages['bibliography']==1){?> style="background:green; color:#FFF;" <?php }?>>Bibliography</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./data/submissionSixUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['filem']==1){?> style="background:green; color:#FFF;" <?php }?>>Attached Files</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['filem']==1){?> style="background:green; color:#FFF;" <?php }?>>Attached Files</li><?php }?>


<?php if($totalstudy>=1){?><li><a href="./data/submissionFinishUp/<?php echo $rstudy['id'];?>/" <?php if($rsSubStages['payments']==1){?> style="background:green; color:#FFF;" <?php }?>>Payments</a></li><?php }?>
...
if($_GET['call']=="DelsubmissionThirdUp"){
	$recruit=$_GET['recruit'];
$upDelete="delete from ".$prefix."study_description_age  where owner_id='$asrmApplctID' and protocol_id='$id' and id='$recruit'";
$mysqli->query($upDelete);

$sqlAgeTotal="SELECT * FROM ".$prefix."study_description_age where `owner_id`='$asrmApplctID' and is_sent='0' and protocol_id='$id' order by id desc limit 0,1";
...
$sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y %H:%s:%i') AS created FROM ".$prefix."submission_country where owner_id='$asrmApplctID' and submission_id='$id' order by id desc LIMIT 0,10";//and conceptm_status='new' 
...
$rmunicipalities=$resultmunicipalities->fetch_array();
	...
	?>
                          <tr>
                            ...
                            <td><a href="main.php?option=submissionThirdUp&id=<?php echo $protocol_id;?>&call=remove&part=<?php echo $rInvestigator['id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this Institution?');">Remove</a></td>
                          </tr>
   <?php 
...
$qRPersoneldSum2="select *,sum(quantity) as TotalQuantity from ".$prefix."study_description_age  where owner_id='$asrmApplctID' and protocol_id='$id' group by protocol_id";
...
$sqlSubmissionCountry2 = "select *,sum(participants) as TotalParticipants FROM ".$prefix."submission_country where owner_id='$asrmApplctID' and submission_id='$id' group by submission_id";//and conceptm_status='new' 
...
echo $message="<p class='error2'>Recruitment Areas and Study Participants totals don't match. Please update.</p>";
	...
	$sqlASubmissionStages="update ".$prefix."submission_stages  set `study_description`='1' where `owner_id`='$asrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages2);
...
$qRPersoneld2="select * from ".$prefix."study_description_age  where owner_id='$asrmApplctID' and protocol_id='$id'";
...
<tr>
            ...
            <a href="main.php?option=submissionThirdUp&id=<?php echo $protocol_id;?>&call=DelsubmissionThirdUp&recruit=<?php echo $rowRows2['id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this record?');">Delete</a></td>
        </tr>
