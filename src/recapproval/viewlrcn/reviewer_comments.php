...
$sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y %H:%s:%i') AS createdm FROM ".$prefix."initial_committee_screening where reviewer_id='$reviewer_session_id' and protocol_id='$protocol_idwe' order by id desc LIMIT 0,50
";//and conceptm_status='new' 
