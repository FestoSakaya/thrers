        ...
        <tbody>
            <tr>
                <td align='center' valign='top'>
                    <table border='0' cellpadding='0' cellspacing='0' width='100%' style='table-layout:fixed;max-width:870px;'>
                        <tbody>    
                            <tr>
                                <td align='center' valign='top'>
...
<table width='100%' border='0'>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><p align='center'><b>REC CONDITIONAL APPROVAL</b></p></td>
  </tr>
  <tr>
...
<b>Re:</b> <b>$public_title</b><br><br></td>
  </tr>
  <tr>
    <td colspan='2' align='left' valign='top'>
	

This is to inform you that the <b>$recOriginalName</b> at its <b>$MeetingNumber</b> held on <b>$Meetingdate</b> reviewed the initial submission of the above-named study and granted approval. The committee however noted the following that need to be addressed;<br><br>
