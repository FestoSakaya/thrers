...
if($_POST['doFilesUpload']=='Save' and  $_POST['project_id'] and $_POST['Version'] and $_POST['Language'] and $id and $_POST['DocumentName']){
...
$wmRenewals3="select * from ".$prefix."submission where  id='$id'";
...
$sqlprotocalSubSel="SELECT * FROM ".$prefix."ammendments_documents where amendment_id='$id' and owner_id='$sessionasrmApplctID' and atype='$file_type' and fileAttachment='$fileattachment' and is_sent!='1'";
...
values('$sessionasrmApplctID','$project_id','$recAffiliated_id','','$fileattachment','$DocumentName',now(),'Pending','Not Assigned','','','$Language','$Version','$Date','$code','$ReasonforAmendment','$changestostudyDistricts','$ChangestoConsentForm','$ChangestodataCollectionTool','$ChangestoProtocol','','','','Not Paid ','','online','','','$id','$otherattachment')";
$mysqli->query($sqlA2);
}
...
////Attached Payment
$sqlPayment="SELECT * FROM ".$prefix."ammendments_documents where `owner_id`='$asrmApplctID' and is_sent='0' and atype='Payment' and amendment_id='$id' order by id desc limit 0,1";
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=ApplyAmmendmentsPay&id='.$id.'">';
...
<?php
if($_GET['del']=='true' and $category=='ApplyAmmendmentsSec' and $id){
...
$wmPayment="select * from ".$prefix."ammendments_documents where  `owner_id`='$sessionasrmApplctID' and atype='Payment'  and is_sent!='1'  and amendment_id='$id' order by id desc limit 0,1";
...
<div id="myModal" class="modal" style="margin-top:80px;">
 ...
 <input name="project_id" type="hidden" value="<?php echo $rRenewals['protocol_id'];?>"/>
