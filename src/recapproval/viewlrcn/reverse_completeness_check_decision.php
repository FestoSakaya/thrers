...
<li><a href="#" rel="#default" class="selected">Reverse Completeness Check Decision</a></li>
...
$sqlstudym4="SELECT * FROM ".$prefix."protocol where id='$id' order by id desc limit 0,1";
$Querystudym4 = $mysqli->query($sqlstudym4);
$rstudym4 = $Querystudym4->fetch_array();
$ProtoclRefNo=$rstudym4['code'];
/////Get Email for REC Admin list_rec_affiliated

if($category=='ReverseCompCheckDecision' and $owner_id and $ProtoclRefNo and $recAffiliated_idREC){
...
$update="update ".$prefix."submission set status='completeness check',assignedto='Not Assigned',CompletenessCheck='Pending' where protocol_id='$protocol_idwe' and owner_id='$owner_id'";
$mysqli->query($update);
