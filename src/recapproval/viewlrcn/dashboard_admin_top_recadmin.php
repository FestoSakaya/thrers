 <?php
 $sqlstudyPending="SELECT * FROM ".$prefix."submission where is_sent='0' and recAffiliated_id='$recAffiliated_id' order by id desc";
$QuerystudyPending = $mysqli->query($sqlstudyPending);
$totalstudyPending = $QuerystudyPending->num_rows;

 $sqlstudyassignedto="SELECT * FROM ".$prefix."submission where status='Scheduled for Review' and recAffiliated_id='$recAffiliated_id' order by id desc";
$Querystudyassignedto = $mysqli->query($sqlstudyassignedto);
$totalstudyassignedto = $Querystudyassignedto->num_rows;

$sqlstudySubmitted="SELECT * FROM ".$prefix."submission where is_sent='1' and recAffiliated_id='$recAffiliated_id' order by id desc";
...
$rstudySubmitted = $QuerystudySubmitted->fetch_array();
 ...
 $sqlstudyApproved="SELECT * FROM ".$prefix."submission where status='Approved' and recAffiliated_id='$recAffiliated_id' order by id desc";
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="item d-flex align-items-center">
                    ...
                    <div class="title"><span>Scheduled for Review</span>
                      <div class="progress">
                        <div role="progressbar" style="width: 10%; height: 40px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-green"></div>
                      </div>
                    </div>
