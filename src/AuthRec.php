...
$recNamew=$rs_check->fetch_array();
$email=$recNamew['email'];
$dbfirstname=$recNamew['name'];
...
echo $messageOK='<div class="success">Thank you. Account has been activated.</div>';
...
$mail->Username = "uncstapps@gmail.com"; // SMTP username -- CHANGE --
$mail->Password = "lpupvbvillxraaey"; // SMTP password -- CHANGE --
$mail->setFrom("uncstapps@gmail.com", "Admin");
/////////////////////////////Begin Mail Body

$mail->FromName = "Account Activation from NRIMS"; //From Name -- CHANGE --
...
$mail->Subject = "Account Activation from NRIMS";
$body="
Dear $dbfirstname !<br><br>
Your account on National Research Information Management System (NRIMS) has been activated. <br><br>
Please login using the credentials in the previous email to review.
<br><br>
                        ...
                        <div class="maine_action">
                            ...
                            <div class="col-md-4">
                                <div class="action_btn text-left sm-text-center">
                                    <a href="<?php echo $base_url;?>" class="btn btn-default">NRIMS</a>
                                </div>
                            </div>
                        </div>
                    </div>
