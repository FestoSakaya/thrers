<?php
$sqlstudymAmmendment="SELECT * FROM ".$prefix."ammendments where `owner_id`='$asrmApplctID' and is_sent='0' order by id desc limit 0,1";
...
<li><a href="#" rel="#default" class="selected">Amendment Information</a></li>

<li class="extra">Attachments</li>

<li class="extra">Payment</li>
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=ApplyAmmendments">';
echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
}
if($_POST['amendmenttype']=='manual'){
echo '<meta http-equiv="REFRESH" content="2;url='.$base_url.'/main.php?option=ManualAmmendments">';
	echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=ApplyAmmendments&id='.$amendment_id.'">';
echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
}
if($ammendType=='manual' and $amendment_id){
echo '<meta http-equiv="REFRESH" content="2;url='.$base_url.'/main.php?option=ManualAmmendments&id='.$amendment_id.'">';
	echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
