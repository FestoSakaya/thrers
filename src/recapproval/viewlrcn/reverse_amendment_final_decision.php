...
if($category=='ReverseAmendmentFinalDecision' and $id and $owner_id and $recAffiliated_idREC){
...
$update="update ".$prefix."ammendments set is_sent='1',status='Submitted',CompletenessCheck='Approved' where id='$id' and owner_id='$owner_id'";
$mysqli->query($update);
