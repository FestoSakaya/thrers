...
<li><a href="#" rel="#default" class="selected">Reverse Final Decision</a></li>
...
if($category=='ReverseFinalDecisionRenewal' and $owner_id and $recAffiliated_idREC){
...
//'Pending','Approved','rejected','fowarded','new','Scheduled for Review','submitted','Conditional Approval','Resubmit'

$update="update ".$prefix."renewals set assignedto='Assigned',status='Scheduled for Review' where id='$id' and owner_id='$owner_id'";
$mysqli->query($update);
...
echo '<meta http-equiv="refresh" content="1; url='.$base_url.'/main.php?option=AnnualRenualMaREC" />';
}
?>
</div>