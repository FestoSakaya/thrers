                                        ...
                                        <tbody>
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                   ...
                                                   Safety and Other Notifications</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<table width='100%' border='0'>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><p align='center'><b>Safety and Other Notifications APPROVED</b></p></td>
  </tr>
  <tr>
   ...
   $institution<br>
   $phone<br> 
   <strong>Type:</strong> Notifications<br><br> 
      
<b>Re:</b> <b>$public_title</b><br><br></td>
  </tr>
  
  <tr>
    <td colspan='2' align='left' valign='top'><p>I am pleased to inform you that at the <strong>$MeetingNumber</strong> convened meeting on <strong>$Meetingdate,</strong> the $recOriginalName reviewed the Safety and Other Notifications  to the  above referenced study and found it satisfactory. 	 
