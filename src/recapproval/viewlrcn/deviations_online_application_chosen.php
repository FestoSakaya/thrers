...
<?php echo $rowRows['Measurestomitigatedeviation'];?> <a href="main.php?option=ChooseChooseDeviationsOnline&id=<?php echo $id;?>&comobje=del&dvid=<?php echo $rowRows['id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></label><br />
<?php
}
...
{ ///Display data for education history
	?>  <label class="form-control-label">
<?php echo $rowRows2['Measurestomitigatedeviation'];?> <a href="main.php?option=ChooseDeviationsOnline&id=<?php echo $id;?>&desv=del&bdiv=<?php echo $rowRows2['id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></label><br />
<?php
}
...
{ ///Display data for education history
	?>  <label class="form-control-label">
<?php echo $rowRows['Measurestomitigatedeviation'];?> <a href="main.php?option=ChooseDeviationsOnline&id=<?php echo $id;?>&comobje=del&dvid=<?php echo $rowRows['id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></label><br />
<?php
}
