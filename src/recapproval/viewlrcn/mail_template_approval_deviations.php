...
<table width='100%' border='0'>
  ...
  <tr>
    <td colspan='2' align='left' valign='top'><p align='center'><b>Deviations APPROVED</b></p></td>
  </tr>
  <tr>
   ...
   $institution<br>
   $phone<br> 
   <strong>Type:</strong> Deviations<br><br> 
      
<b>Re:</b> <b>$protocolCode:  $public_title, $ProtocolVersion, $DateofProposal</b><br><br></td>
  </tr>
  
  <tr>
    <td colspan='2' align='left' valign='top'><p>I am pleased to inform you that at the <strong>$MeetingNumber</strong> convened meeting on <strong>$Meetingdate,</strong> the $recOriginalName reviewed the Deviations to the  above referenced study and found it satisfactory. 	 
