...
?>
<?php
if($_POST['doSaveThree']=='Save and Next' and $mysqli->real_escape_string(htmlentities($_POST['study_design'])) and $_POST['asrmApplctID'] and $mysqli->real_escape_string(htmlentities($_POST['health_condition']))){
//htmlspecialchars($str, ENT_QUOTES);
	$study_design=$mysqli->real_escape_string(htmlentities($_POST['study_design']));
	$health_condition=$mysqli->real_escape_string(htmlentities($_POST['health_condition']));
...
//
//$sqlRecruits="SELECT * FROM ".$prefix."submission_country where `owner_id`='$asrmApplctID' and submission_id='$id'  and country_id>=1 and participants>=1 and gender>=1 and MinimumAge>=1 and MaximumAge>=1 order by id desc limit 0,1";
...
$mysqli->query($sqlASubmissionStages);
echo("<script>location.href = '$base_url/main.php?option=StudyPopulationUp&id=$id';</script>");
...
<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionUp&id=<?php echo $id;?>" <?php if($rsSubStages['protocol_information']==1 and $rsSubStages['protocol_team']==1){?> style="background:green; color:#FFF;" <?php }?>>Protocol Information</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionSecondUp&id=<?php echo $id;?>" <?php if($rsSubStages['protocol_details']==1){?> style="background:green; color:#FFF;" <?php }?>>Protocol Details</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./main.php?option=StudyPopulationUp&id=<?php echo $id;?>" <?php if($rsSubStages['study_population']==1){?> style="background:green; color:#FFF;" <?php }?>>Study Population</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionFourUp&id=<?php echo $id;?>" <?php if($rsSubStages['registry']==1){?> style="background:green; color:#FFF;" <?php }?>>Registry</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['registry']==1){?> style="background:green; color:#FFF;" <?php }?>>Registry</li><?php }}?>

<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionBudgetUp&id=<?php echo $id;?>" <?php if($rsSubStages['budget']==1){?> style="background:green; color:#FFF;" <?php }?>>Budget</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['budget']==1){?> style="background:green; color:#FFF;" <?php }?>>Budget</li><?php }?>

<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionScheduleUp&id=<?php echo $id;?>" <?php if($rsSubStages['study_work_plan']==1){?> style="background:green; color:#FFF;" <?php }?>>Study Work Plan</a></li><?php }?>
...
<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionSixUp&id=<?php echo $id;?>" <?php if($rsSubStages['filem']==1){?> style="background:green; color:#FFF;" <?php }?>>Attached Files</a></li><?php }?>
<?php if(!$totalstudy){?><li class="extra" <?php if($rsSubStages['filem']==1){?> style="background:green; color:#FFF;" <?php }?>>Attached Files</li><?php }?>


<?php if($totalstudy>=1){?><li><a href="./main.php?option=submissionFinishUp&id=<?php echo $id;?>" <?php if($rsSubStages['payments']==1){?> style="background:green; color:#FFF;" <?php }?>>Payments</a></li><?php }?>
...
<form action="<?php echo $base_url;?>main.php?option=submissionThirdUp&id=<?php echo $id;?>" method="post" name="regForm" id="regForm" autocomplete="false">                        
