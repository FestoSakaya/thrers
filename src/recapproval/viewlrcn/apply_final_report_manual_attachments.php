...
<li><a href="./main.php?option=ManualFinalReport&id=<?php echo $id;?>&rec=<?php echo $rec;?>"  style="background:green; color:#FFF;">Apply for Close Out Report</a></li>
...
if($category=='ManualFinalReportProceed' and $id and $rec){
...
<?php if($totalstudy){?>					
					<input name="doSaveFinish" type="button"  class="btn-secondary" value="Make Final Submission" style="float:right; margin-top:5px; "  onClick="window.location.href='<?php echo $base_url;?>main.php?option=ManualFinalReportProceed&id=<?php echo $id;?>&rec=<?php echo $rec;?>'"/>
