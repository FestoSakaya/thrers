...
$sqlprotocalSubSel="SELECT * FROM ".$prefix."protocol where id='$id'";
...
/////update slip
$sqlA2Protocol="update ".$prefix."submission  set `paymentStatus`='Not Confirmed',`paymentProof`='$attachpayment2', `type_of_payment`='$type_of_payment' where id='$id' and owner_id='$asrmApplctID'";
...
$wmPopulation="select * from ".$prefix."study_population where  owner_id='$asrmApplctID' and protocol_id='$id' and status='new'";
...
$sqlA2Protocol2="update ".$prefix."submission set `paymentProof`='', `type_of_payment`='' where id='$id' and owner_id='$asrmApplctID'";
	$mysqli->query($sqlA2Protocol2);
	
	$sqlASubmissionStages="update ".$prefix."submission_stages  set `payments`='0' where `owner_id`='$asrmApplctID' and `protocol_id`='$id'";
$mysqli->query($sqlASubmissionStages);
	}
