                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Change of Review Type - $public_title</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
Thank you for your protocol titled, '<b>$public_title</b>' After review, we have been advised to change your review type to <b>$type_of_review</b>.<br /><br />
You can make an appeal if you are not satisfied with the decision.<br /><br />
