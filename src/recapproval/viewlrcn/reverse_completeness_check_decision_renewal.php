...
if($category=='ReverseCompCheckRenewal' and $owner_id and $recAffiliated_idREC){
...
$update="update ".$prefix."renewals set assignedto='Not Assigned',CompletenessCheck='Pending' where id='$id' and owner_id='$owner_id'";
$mysqli->query($update);
