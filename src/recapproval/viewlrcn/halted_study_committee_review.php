...
$sqlA2="insert into ".$prefix."initial_committee_screening (`owner_id`,`protocol_id`,`created`,`updated`,`screening`,`draftopinion`,`recAffiliated_id`,`reviewer_id`) 

values('$asrmApplctID_user','$protocol_idmm',now(),now(),'$screening','$draftopinion2','$recAffiliated_c','$asrmApplctID')";
$mysqli->query($sqlA2);

/*$sqlA2rr="insert into ".$prefix."submission_review_sr (`asrmApplctID`,`protocol_id`,`owner_id`,`reviewer_id`,`reviewDate`,`recstatus`) 

values('$asrmApplctID','$protocol_idmm','$asrmApplctID_user','$asrmApplctID',now(),'Pending')";
$mysqli->query($sqlA2rr); Ignore*/
		}
