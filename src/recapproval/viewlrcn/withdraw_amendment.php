...
<li><a href="#" rel="#default" class="selected">Notice for Withdrawal of Amendment</a></li>
...
$update="update ".$prefix."ammendments set is_sent='0',status='Pending',assignedto='Not Assigned',CompletenessCheck='Pending' where id='$id' and owner_id='$owner_id'";
$mysqli->query($update);
...
$mail->Subject = "Notice for Withdrawal of Amendment - $ProtoclRefNo";
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    ...
                                                    Notice for Withdrawal of Amendment - $ProtoclRefNo</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<b>Subject: Notice for Withdrawal of Amendment Ref No: $ProtoclRefNo</b><br><br>

This is to notify you that Amendment submission : <b>$public_title</b>, Ref No: <b>$ProtoclRefNo</b> has been withdrawn.<br><br>
...
echo $message='<p class="success">Thank you, Amendment has been withdrawn.</p>';
...
echo '<meta http-equiv="refresh" content="1; url='.$base_url.'/main.php?option=MyAmmendments" />';
}
?>
</div>