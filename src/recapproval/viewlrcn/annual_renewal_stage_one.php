<?php
$sqlstudymAmmendment="SELECT * FROM ".$prefix."renewals where `owner_id`='$asrmApplctID' and is_sent='0' order by id desc limit 0,1";
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=AnnualRenual">';
echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
}
if($_POST['amendmenttype']=='manual'){
echo '<meta http-equiv="REFRESH" content="2;url='.$base_url.'/main.php?option=AnnualRenualManual">';
	echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=AnnualRenual&id='.$amendment_id.'">';
echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
}
if($ammendType=='manual' and $amendment_id){
echo '<meta http-equiv="REFRESH" content="2;url='.$base_url.'/main.php?option=AnnualRenualManual&id='.$amendment_id.'">';
	echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
