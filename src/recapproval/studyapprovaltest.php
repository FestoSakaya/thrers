...
$dateupdated=$rSw2['dateupdated'];
$approvalText=$rSw2['approvalText1'];
$approvalText2=$rSw2['approvalText2'];//nl2br()
$categoryChunksss = explode("<br><br>", $rSw2['approvalText2']);
$chops1="$categoryChunksss[0]";
$chops2="$categoryChunksss[1]";
if($dateupdated<='2022-06-05'){$breaks="<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>";}
if($dateupdated>='2022-06-06'){$breaks="<br><br><b>Below is the list of documents that were reviewed.</b><br><br>";}
...
$approvalText
$chops1<br><br>
The committee however requests you to address the <a href="$base_url/recapproval/downloadcomments.php?rmd_id=MzEwOA==">comments in this link</a> within 4 weeks.
$breaks
