...
<li><a href="./data/initialCommitteeReview/<?php echo $id;?>/">Reviewer Comments</a></li>
<li><a href="./data/initialCommitteeReviews/<?php echo $id;?>">Initial Committee Review</a></li>
...
if($_POST['doEndReview']=='Save Decision and Finalize Process' and $_POST['public_title'] and $id and $_POST['recruitment_status']=='Approved' and $_POST['whosigns']){
...
$sqlSmeeting = "select * from ".$prefix."meeting where protocol_id='$protocol_idmm' order by id desc";
...
$nummm=1;
$restudytools="select * from ".$prefix."submission_upload where  user_id='$asrmApplctID_user' and submission_id='$protocol_idmm' order by id desc";
...
/////////////////////////////////////////submission_upload//////////////////////	
$sqlSProtocol = "select * from ".$prefix."submission_upload where user_id='$asrmApplctID_user' and submission_id='$protocol_idmm' and upload_type_id='1' order by id desc";
...
$body="$allSentMessage
<br><br>
<a href='$base_url/recapproval/studyapproval.php?rmd_id=$rstug_UNCSTRefNumber2' style='background:#06F; border: none;  color: white; padding: 15px 32px;  text-align: center;  text-decoration: none;  display: inline-block; font-size: 16px;' target='_blank'>Download/Print PDF</a>";
$mail->MsgHTML($body);
...
if($screeningmessage){
require_once("viewlrcn/mail_template_final_decision_comments.php");
$mail = new PHPMailer(true); //important
$mail->IsSMTP(); // set mailer to use SMTP
$mail->Port = "587"; // SMTP Port
$mail->CharSet =  "utf-8";
...
$mail->FromName = "$recOriginalName"; //From Name -- CHANGE --
$mail->AddAddress($owneremail, $ownername); //To Address -- CHANGE --
$mail->addCc($signedEmail,$recOriginalName);///To UNCST
$mail->AddReplyTo($recemail, $ownername); //Reply-To Address -- CHANGE --$usrm_email
...
echo '<meta http-equiv="refresh" content="2; url=$base_url/recapproval/data/dashboard" />';
	
}
/////////////////////////////Rejection/////////////////////////////////////////////////////////
if($_POST['doEndReview']=='Save Decision and Finalize Process' and $_POST['public_title'] and $id and $_POST['recruitment_status']=='Rejected' and $_POST['whosigns']){
require("viewlrcn/class.phpmailer.php");
require("viewlrcn/class.smtp.php");
...
$Approvaltoday;
$endofproject = date("d/m/Y", strtotime($dateSubmitted . "+12 month"));
$endofproject2 = date("Y-m-d", strtotime($dateSubmitted . "+12 month"));
$nummm=1;
$restudytools="select * from ".$prefix."submission_upload where  user_id='$asrmApplctID_user' and submission_id='$protocol_idmm'";
$cmdtools = $mysqli->query($restudytools);
while($DBtools= $cmdtools->fetch_array()){
	$nummm+1;
$upload_type_id=$DBtools['upload_type_id'];
...
$sqlA23="update ".$prefix."submission set `status`='$recruitment_status',`meeting_status`='Completed',`reviewer_id`='$reviewer_id' where `owner_id`='$asrmApplctID_user' and `id`='$submission_idm'";
$mysqli->query($sqlA23);
$message='<p class="success">Review was completed successfully. Thank You</p>';
//send email to protocol owner
...
$body="$allSentMessage
<br><br>
<a href='$base_url/recapproval/studyapprovals.php?rmd_id=$rstug_UNCSTRefNumber2' style='background:#06F; border: none;  color: white; padding: 15px 32px;  text-align: center;  text-decoration: none;  display: inline-block; font-size: 16px;' target='_blank'>Download/Print PDF</a>";
$mail->MsgHTML($body);
...
/////////////////////////////Conditional Approval/////////////////////////////////////////////////////////
if($_POST['doEndReview']=='Save Decision and Finalize Process' and $_POST['public_title'] and $id and $_POST['recruitment_status']=='Conditional Approval'){
require("viewlrcn/class.phpmailer.php");
require("viewlrcn/class.smtp.php");
...
if($_POST['doEndReview']=='Save Decision and Finalize Process' and $_POST['public_title'] and $id and $_POST['recruitment_status']=='Request for Responses'){
require("viewlrcn/class.phpmailer.php");
require("viewlrcn/class.smtp.php");
...
$body="$allSentMessageConditional
<br><br>
<a href='$base_url/recapproval/studyapprovalres.php?rmd_id=$rstug_UNCSTRefNumber2' style='background:#06F; border: none;  color: white; padding: 15px 32px;  text-align: center;  text-decoration: none;  display: inline-block; font-size: 16px;' target='_blank'>Download/Print PDF</a>";
$mail->MsgHTML($body);
...
/////////////////////////////Request for VIVA/////////////////////////////////////////////////////////
if($_POST['doEndReview']=='Save Decision and Finalize Process' and $_POST['public_title'] and $id and $_POST['recruitment_status']=='Request for VIVA' and $_POST['meetingplace'] and $_POST['meeting_set_date']){
require("viewlrcn/class.phpmailer.php");
require("viewlrcn/class.smtp.php");
...
$body="$allSentMessageConditional
<br><br>
<a href='$base_url/recapproval/studyapprovalviv.php?rmd_id=$rstug_UNCSTRefNumber2' style='background:#06F; border: none;  color: white; padding: 15px 32px;  text-align: center;  text-decoration: none;  display: inline-block; font-size: 16px;' target='_blank'>Download/Print PDF</a>";
$mail->MsgHTML($body);
...
<input name="protocolCode" type="hidden" value="<?php echo $rprotocalSub2Sel['code'];?>"/>
