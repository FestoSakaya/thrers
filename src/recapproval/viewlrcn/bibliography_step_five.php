...
<?php }?>
       ...
       <?php
	   if($category=='submissionFiveEmpRemove'){
...
<tr>
            ...
            <td><a href="./main.php?option=submissionFiveEmpRemove&id=<?php echo $rowRows2['rstug_employment_id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
        </tr><?php } ?> 
</table>
<?php } ?> 
...
<?php }?>
            ...
            <td><input type="button" id="addmorePOIbutton" value="Add Rows" onClick="insRow2()" style="font-size:12px;"/></td>
             ...
             <?php
if($category=='submissionFiveRemove'){
...
<tr>
            ...
            <td><?php echo $rowRows['rstug_educn_period'];?> 
                 ...
                 <td><a href="./main.php?option=submissionFiveRemove&id=<?php echo $rowRows['rstug_educn_id'];?>" style="color:#F00; font-weight:bold;" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
        </tr>
