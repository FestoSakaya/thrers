...
<?php
$sqlstudym="SELECT * FROM ".$prefix."submission_archive where id='$id' order by id desc limit 0,1";
...
$sqlprotocalSubSel="SELECT * FROM ".$prefix."protocol_archive where id='$protocol_idwe' and owner_id='$owner_id'";
...
<?php if($rprotocalSub2Sel['changeofreview']=='Yes'){?><input id="go" type="button" value="Click to Appeal for Change Review Type" onclick="window.open('<?php echo $base_url;?>changeofreviewappeal.php?id=<?php echo $id;?>','popUpWindow','height=700, width=1000, left=100, top=100, resizable=yes, scrollbars=yes, toolbar=yes, menubar=no, location=no, directories=no, status=yes');"  class="errorm3" ><?php }?>
...
<button class="accordion">Protocol Information, click to review</button>
  <div class="panel">
  <?php
  $sqlprotocalSub="SELECT * FROM ".$prefix."submission_archive where  id='$protocol_idwe' order by id desc limit 0,1";
...
$sqlprotocalSub2="SELECT * FROM ".$prefix."protocol_archive where  id='$protocol_id'";
...
$sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y %H:%s:%i') AS created FROM ".$prefix."team_archive where owner_id='$owner_id' and protocol_id='$protocol_idwe' order by id desc LIMIT 0,10";//and conceptm_status='new' 
...
<button class="accordion">Protocol Details, click to review</button>
  <div class="panel">
  <?php
$sqlprotocalSubrr="SELECT * FROM ".$prefix."submission_archive where  id='$protocol_idwe' and owner_id='$owner_id' order by id desc limit 0,1";
...
<button class="accordion">Budget Information, click to review</button>
  <div class="panel">
   <?php
$Q_R="select * from ".$prefix."research_project_expenditure_archive where rstug_user_id='$owner_id' and rstug_rsch_project_id='$protocol_idwe' order by rstug_expenditure_id desc";
$QCMD=$mysqli->query($Q_R);
$rS=$QCMD->fetch_array();

 $Q_RLocal="select * from ".$prefix."research_project_expenditure_local_archive where rstug_user_id='$owner_id' and rstug_rsch_project_id='$protocol_idwe' order by rstug_expenditure_id desc";
...
?>
 ...
 <?php
  $sqlstudyff="SELECT * FROM ".$prefix."submission_archive where id='$protocol_idwe' order by id desc limit 0,1";
$Querystudyff = $mysqli->query($sqlstudyff);
$rstudyff = $Querystudyff->fetch_array(); 
?>              

<table border="1" cellspacing="0" cellpadding="0" align="left" width="100%" class="table">
...
<hr />
   <?php
 $sqlstudyDD="SELECT * FROM ".$prefix."submission_archive where id='$protocol_idwe' and owner_id='$owner_id' order by id desc limit 0,1";
...
<?php
$sqlmethodology="SELECT * FROM ".$prefix."clinical_study_methodology_archive where `owner_id`='$owner_id' and protocol_id='$protocol_idwe' order by id desc limit 0,1";
...
<hr />
 <table class="table table-striped table-sm">
                        ...
                        <?php
//if no page var is given, set start to 0
echo $sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y %H:%s:%i') AS created FROM ".$prefix."submission_clinical_trial_archive where submission_id='$protocol_idwe' and owner_id='$owner_id' order by id desc LIMIT 0,10";//and conceptm_status='new' 
$result = $mysqli->query($sql);
while($rInvestigator=$result->fetch_array()){
...
<label class="form-control-label col-sm-12"><!--<strong>Population: Proposed inclusion criteria:</strong> <span class="error">*</span><br />-->
  <?php 
$sqlstudyPop="SELECT * FROM ".$prefix."study_population_archive where `owner_id`='$owner_id' and protocol_id='$protocol_idwe' order by id desc";
...
<?php echo $rstudyP['CommunityEngagementplan'];?>
                     ...
                     <div class="form-group row">
                      ...
                      <?php
$sqlstudyPop2="SELECT * FROM ".$prefix."determination_of_risk_archive where `owner_id`='$owner_id' and protocol_id='$protocol_idwe' order by id desc";
...
$rstudyP2 = $QuerystudyPop2->fetch_array();?>
  ...
  <div class="panel">
  <?php
   $sqlstudyDDw2="SELECT * FROM ".$prefix."submission_archive where id='$protocol_idwe' and owner_id='$owner_id' order by id desc limit 0,1";
...
<label class="form-control-label"><strong style="font-weight:bold;">Ethical Considerations:</strong> <?php echo nl2br($rstudymethodology['ethical_considerations']);?></label>
 ...
 <button class="accordion">Study Work Plan, click to review</button>
  ...
  <table class="table table-striped table-sm">
                        ...
                        <?php
//if no page var is given, set start to 0
$sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y') AS created,DATE_FORMAT(`updated`,'%d/%m/%Y') AS updated FROM ".$prefix."submission_task_archive where submission_id='$protocol_idwe' and owner_id='$owner_id' order by id desc LIMIT 0,10";//and conceptm_status='new'  %H:%s:%i
$result = $mysqli->query($sql);
while($rInvestigator=$result->fetch_array()){
	?>
                          <tr>
  ...
  <table class="table table-striped table-sm">
                        ...
                        <?php
//if no page var is given, set start to 0
$sql = "select *,DATE_FORMAT(`created`,'%d/%m/%Y %H:%s:%i') AS created FROM ".$prefix."submission_upload_archive where user_id='$owner_id' and submission_id='$protocol_idwe' order by id desc LIMIT 0,10";//and conceptm_status='new' 
$result = $mysqli->query($sql);
while($rInvestigator=$result->fetch_array()){
...
$rUsers=$resultUser->fetch_array();
   ...
   $sqlstudyff="SELECT *,DATE_FORMAT(`updated`,'%d/%m/%Y %H:%s:%i') AS updated FROM ".$prefix."submission_archive where id='$protocol_idwe' order by id desc limit 0,1";
$Querystudyff = $mysqli->query($sqlstudyff);
$rstudyff = $Querystudyff->fetch_array(); 
