...
");
 ...
 $sendText2=$mysqli->real_escape_string("This is to inform you that the <b>$recOriginalName</b> held on <b>$Meetingdate</b> reviewed the Annual Renewal of the above-named study and granted conditional approval. The committee however noted the following that need to be addressed;<br><br>
