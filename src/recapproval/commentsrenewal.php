...
$sql = "select * FROM ".$prefix."initial_committee_screening where  reviewer_id='$asrmApplctID' and renewal_id='$id' order by id desc LIMIT 0,100";//and conceptm_status='new'
