...
<li><a href="#" rel="#default" class="selected">SAEs Information</a></li>
...
echo '<meta http-equiv="REFRESH" content="1;url='.$base_url.'/main.php?option=SAEsOnline">';
echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
}
if($_POST['amendmenttype']=='manual'){
echo '<meta http-equiv="REFRESH" content="2;url='.$base_url.'/main.php?option=SAEsManual">';
	echo '<img src="images/loading_wait.gif">';
echo '<div class="spacer"></div>';
