                                            ...
                                            <tr>
                                                <td align='center' style='padding-bottom:15px;text-transform:uppercase;padding-top:30px' valign='middle'>
                                                    <h1 style='color:white;text-align:center;font-size:24px;line-height:1.2em;max-width:100%;vertical-align:middle;word-wrap:break-word'>
                                                        Completeness Check (Complete) - $ProtoclRefNo</h1>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
Dear $name !<br><br>
Thank you for submitting your protocol to conduct a study titled, '<b>$public_title</b>'.<br /><br />
This is to notify you that your protocol has been checked for completeness<br /><br />

Your protocol application will be scheduled for review and the outcomes communicated to you in an email.
<br /><br />
