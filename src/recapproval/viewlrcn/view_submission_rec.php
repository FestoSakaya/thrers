...
<label class="form-control-label"><strong style="font-weight:bold;">Estimated date of initial recruitment:</strong> <?php echo nl2br($rstudyDD['recruitment_init_date']);?></label> 
<hr />
